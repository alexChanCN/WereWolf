...
public class WxMenuController implements WxMpMenuService {
    ...
    public String menuCreateSample() throws WxErrorException {
        ...
        button1.setName("银豹系统");
        //button1.setKey("V1001_TODAY_MUSIC");
        //button1.setUrl("http://moss7.pospal.cn/");
        ...
        button11.setName("点单测试");
        button11.setUrl("http://pospalsales.pospal.cn/");
       /* WxMenuButton button12 = new WxMenuButton();
        button12.setType(WxConsts.BUTTON_VIEW);
        button12.setName("点单测试2");
        button12.setUrl("http://pospalsales.pospal.cn/");
        WxMenuButton button13 = new WxMenuButton();
        button13.setType(WxConsts.BUTTON_VIEW);
        button13.setName("会员测试");
        button13.setUrl("http://moss7.pospal.cn/m/account");
        WxMenuButton button14 = new WxMenuButton();
        button14.setType(WxConsts.BUTTON_VIEW);
        button14.setName("签到测试");
        button14.setUrl("http://moss7.pospal.cn/m/home/welcome");*/
...
/*        button1.getSubButtons().add(button12);
        ...
        button21.setName("会员中心");
        button21.setUrl("http://shine1.tunnel.qydev.com/index.html");

       /* WxMenuButton button22 = new WxMenuButton();
        button22.setType(WxConsts.BUTTON_CLICK);
        button22.setName("我的ID");
        button22.setKey("ID");

        WxMenuButton button23 = new WxMenuButton();
        button23.setType(WxConsts.BUTTON_CLICK);
        button23.setName("我的资料");
        button23.setKey("PROFILE");*/
       ...
       /* button2.getSubButtons().add(button22);
        ...
        button31.setName("网页测试");
        button31.setUrl("http://shine1.tunnel.qydev.com/hello/");*/

        WxMenuButton button32 = new WxMenuButton();
        button32.setType(WxConsts.BUTTON_VIEW);
        button32.setName("图片测试");
        button32.setUrl("http://shine1.tunnel.qydev.com/1.jpg");
